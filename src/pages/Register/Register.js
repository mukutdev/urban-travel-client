...
const Register = () => {
    ...
    const {user , handleUserRegistration , updateUserProfile } = useContext(AuthProvider)
    ...
    return (
        ...
        <div className="w-1/3 mx-auto my-28">
          <div className="shadow-md p-8 rounded ">
           {
                user?.uid ? `You are Logged in ${user?.displayName}`:<> <h2 className="text-center text-xl font-medium">
                Create Your Account
              </h2>
